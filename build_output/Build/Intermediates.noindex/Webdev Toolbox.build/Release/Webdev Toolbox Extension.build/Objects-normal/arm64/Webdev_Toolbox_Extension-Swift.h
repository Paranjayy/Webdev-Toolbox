...
#ifndef WEBDEV_TOOLBOX_EXTENSION_SWIFT_H
#define WEBDEV_TOOLBOX_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Webdev_Toolbox_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC24Webdev_Toolbox_Extension25SafariWebExtensionHandler")
